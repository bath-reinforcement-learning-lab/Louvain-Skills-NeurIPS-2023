...
#polygon(cip_x, cip_y_lvl4, col = adjustcolor("mediumpurple4", alpha.f = 0.3), border = FALSE)
...
#lines(x, means_lvl4, col = "mediumpurple4")
#points(x, means_lvl4, col = "mediumpurple4", pch = 16)
...
#legend(x = 31, y = 0.52, legend = c("Louvain", "Flat", "Level 1", "Level 2", "Level 3", "Level 4", "Primitive"),
