...
for _ in range(M_REPEATS):
    ...
    for resolution in resolutions:
        results_directory = f"./Training Results/Chapter 2/Resolution Ablation/Rooms/{resolution}/"
    ...
    for i, (start, goal) in enumerate(start_goal_pairs):
        results_directory = "./Training Results/Chapter 2/Resolution Ablation/Rooms/"
