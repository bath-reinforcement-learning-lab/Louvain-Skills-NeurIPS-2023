...
if (dosave) pdf(paste("grid", ".pdf",sep=""), width = 5, height = 4.25)
par(family="serif", mar=c(3.5, 3.5, 1.5, 0) + 0.5, mgp=c(2.5, 1, 0))
plot.new()
plot.window(ylim=c(-1.0, 1.0), xlim=c(0,130))
...
title(main=paste("Grid"), cex.main=2.0, font.main=1)
...
ii <- c(1, 2, 3, 4, 5, 6, 7)
legend(76.7, -1.0425, nice_names[ii], col=c("red", "orange", "forestgreen", "blue", "navy", "darkviolet", "grey30"),
