...
input_file = sprintf("office10k_binary_%s.json", evaluation_type)
output_file = "office10k.pdf"
...
plot.new()
plot.window(ylim=c(-1.75, 0.4), xlim=c(0, max_epoch + 50))
xlabels = c(0, 1000, 2000, 3000, 4000)
axis(1, at=xlabels, labels=xlabels, cex.axis=1.7)
ylabels <- c(-1.6, -1.2, -0.8, -0.4, 0, 0.4)
axis(2, at=ylabels, labels=ylabels, cex.axis=1.7)
title(main=paste("Office (10k)"), cex.main=2.0, font.main=1)
...
text(x = 2750, y = -1.6, labels = "-0.01 per action\n+1.0 at goal", font = 2, adj = 0)
