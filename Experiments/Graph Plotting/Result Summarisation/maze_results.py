...
for eval_type in ["Episode", "Epoch"]:
    ...
    directories = [
        ...
        f"./Training Results/Learning Curves/Maze/{eval_type}/Multi-Level Agent/",
        f"./Training Results/Learning Curves/Maze/{eval_type}/Flat Agent/",
        f"./Training Results/Learning Curves/Maze/{eval_type}/Single-Level Agents/Level 0/",
        f"./Training Results/Learning Curves/Maze/{eval_type}/Single-Level Agents/Level 1/",
        f"./Training Results/Learning Curves/Maze/{eval_type}/Single-Level Agents/Level 2/",
        f"./Training Results/Learning Curves/Maze/{eval_type}/Single-Level Agents/Level 3/",
        f"./Training Results/Learning Curves/Maze/{eval_type}/Betweenness/",
