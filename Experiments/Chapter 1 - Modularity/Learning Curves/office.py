...
office = OfficeBuildingJSONHandler.load_from_json("./Experiments/Chapter 1 - Modularity/Learning Curves/office_1k.json")
...
for _ in range(M_REPEATS):
    ...
    results_directory = "./Training Results/Chapter 1/Learning Curves/Office/"
