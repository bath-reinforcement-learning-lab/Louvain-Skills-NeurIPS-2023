...
axis(2, at = c(-1.0, -0.5, 0.0, 0.5, 1.0), labels = TRUE, cex.axis = 1.7)
...
polygon(cip_x, cip_y_001, col = adjustcolor("#0d0887", alpha.f = 0.3), border = FALSE)
polygon(cip_x, cip_y_01, col = adjustcolor("#7401a8", alpha.f = 0.3), border = FALSE)
polygon(cip_x, cip_y_1, col = adjustcolor("#bf3984", alpha.f = 0.3), border = FALSE)
polygon(cip_x, cip_y_10, col = adjustcolor("#ee7b51", alpha.f = 0.3), border = FALSE)
...
lines(x, means_001, col = "#0d0887")
points(x, means_001, col = "#0d0887", pch = 16, cex=0.6)

lines(x, means_01, col = "#7401a8")
points(x, means_01, col = "#7401a8", pch = 16, cex=0.6)

lines(x, means_1, col = "#bf3984")
points(x, means_1, col = "#bf3984", pch = 16, cex=0.6)

lines(x, means_10, col = "#ee7b51")
points(x, means_10, col = "#ee7b51", pch = 16, cex=0.6)
