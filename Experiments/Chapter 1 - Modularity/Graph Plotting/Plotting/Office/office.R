...
means_modularity <- dataj$"modularity (0.1)"$mean[1:(max_epoch / time_interval)]
sd_modularity <- dataj$"modularity (0.1)"$std_dev[1:(max_epoch / time_interval)] / sqrt(n_runs)
...
points(x, means_modularity, col = "red", pch = 16, cex=0.6)

#legend(x = 156, y = 0.68, legend = c("Modularity", "Primitive", "Label Prop.", "Edge Bet.", "Note Bet.", "Eigenoptions", "Xu et al."),
