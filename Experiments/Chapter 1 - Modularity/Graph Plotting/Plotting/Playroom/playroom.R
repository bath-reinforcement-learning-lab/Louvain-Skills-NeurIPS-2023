...
means_modularity <- dataj$"modularity (0.01)"$mean[1:(max_epoch / time_interval)]
sd_modularity <- dataj$"modularity (0.01)"$std_dev[1:(max_epoch / time_interval)] / sqrt(n_runs)
