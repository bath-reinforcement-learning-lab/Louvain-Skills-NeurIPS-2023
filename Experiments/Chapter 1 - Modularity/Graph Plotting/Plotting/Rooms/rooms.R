...
axis(1, at = c(0, 10, 20, 30, 40, 50, 60), labels = TRUE, cex.axis = 1.7)
...
#legend(x = 25, y = 0.8, legend = c("Modularity", "Primitive", "Label Prop.", "Edge Bet.", "Node Bet.", "Eigenoptions", "Xu et al."),
